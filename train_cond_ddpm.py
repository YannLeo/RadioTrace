...
def parse_args():
    ...
    parser.add_argument("--cfg", help="experiment configure file name", type=str, default='configs/radio_train_DDPM_Tx.yaml')
    # parser.add_argument("")
...
def main(args):
    ...
    if data_cfg['name'] == 'edge':
        ...
        dataset = loaders.RadioUNet_c_multiTx(phase="train")
    else:
        raise NotImplementedError
